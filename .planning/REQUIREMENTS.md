...
- [ ] **COA-01**: Contador pode gerenciar plano de contas hierárquico (até 5 níveis) com código, nome, tipo (Ativo, Passivo, PL, Receita, Despesa), natureza (devedora/credora), flag sintético/analítico, flag permite lançamento manual, status ativo/inativo, com CRUD completo e visualização em árvore expansível
...
- [ ] **COA-04**: Contador pode configurar exercícios fiscais com data início/fim (calendário jan-dez ou safra jul-jun), e períodos contábeis mensais com status (ABERTO, FECHADO, BLOQUEADO), abertura automática do próximo período e impedimento de lançamento em período não aberto
- [ ] **COA-05**: Contador pode vincular centros de custo existentes (fazenda, talhão, atividade) a lançamentos contábeis para DRE gerencial por cultura/fazenda, com rateio proporcional quando lançamento envolve múltiplos centros
...
|-------------|-------|--------|
| COA-01 | Phase 35 | Pending |
| COA-02 | Phase 35 | Pending |
| COA-03 | Phase 35 | Pending |
| COA-04 | Phase 35 | Pending |
| COA-05 | Phase 35 | Pending |
