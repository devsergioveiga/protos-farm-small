...
- [x] 36-04-PLAN.md — Frontend: JournalEntriesPage + JournalEntryModal + ReversalModal + OpeningBalanceWizard
...
- [x] 38-02-PLAN.md — Wire checkPeriodOpen middleware into journal-entries and auto-posting routes
- [x] 38-03-PLAN.md — Frontend: MonthlyClosingPage stepper + hooks + FiscalPeriodsPage button + sidebar + routing
...
**Plans:** 3 plans
Plans:
- [ ] 39-01-PLAN.md — Backend: types, pure calculators (DRE+BP+cross-validation), service, routes, tests
- [ ] 39-02-PLAN.md — Frontend: DRE page with table, V/H toggle, CC filter, margin ranking chart
...
| 35-41 | v1.4 | 15/~41 | In Progress | — |

---
*Last updated: 2026-03-28 after Phase 39 planning*
