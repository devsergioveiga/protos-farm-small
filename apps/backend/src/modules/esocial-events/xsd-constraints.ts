...
export const XSD_CONSTRAINTS: Record<string, XsdElementConstraint[]> = {
  ...
  'S-1000': [
    ...
    { path: 'eSocial/evtInfoEmpregador/ideEmpregador/nrInsc', required: true, minLength: 8, maxLength: 14 },
  ],
  ...
  'S-1005': [
    ...
    { path: 'eSocial/evtTabEstab/ideEmpregador/nrInsc', required: true, minLength: 8, maxLength: 14 },
  ],
  ...
  'S-1010': [
    ...
    { path: 'eSocial/evtTabRubrica/ideEmpregador/nrInsc', required: true, minLength: 8, maxLength: 14 },
  ],
  ...
  'S-1020': [
    ...
    { path: 'eSocial/evtTabLotacao/ideEmpregador/nrInsc', required: true, minLength: 8, maxLength: 14 },
  ],
  ...
  'S-2200': [
    ...
    { path: 'eSocial/evtAdmissao/ideEmpregador/nrInsc', required: true, minLength: 8, maxLength: 14 },
    { path: 'eSocial/evtAdmissao/trabalhador/cpfTrab', required: true, minLength: 11, maxLength: 11, pattern: '^\\d{11}$' },
    { path: 'eSocial/evtAdmissao/trabalhador/nisTrab', required: true, minLength: 11, maxLength: 11 },
  ...
  'S-2206': [
    ...
    { path: 'eSocial/evtAltContratual/ideEmpregador/nrInsc', required: true, minLength: 8, maxLength: 14 },
    { path: 'eSocial/evtAltContratual/ideTrabalhador/cpfTrab', required: true, minLength: 11, maxLength: 11, pattern: '^\\d{11}$' },
  ...
  'S-2230': [
    ...
    { path: 'eSocial/evtAfastTemp/ideEmpregador/nrInsc', required: true, minLength: 8, maxLength: 14 },
    { path: 'eSocial/evtAfastTemp/ideTrabalhador/cpfTrab', required: true, minLength: 11, maxLength: 11, pattern: '^\\d{11}$' },
    { path: 'eSocial/evtAfastTemp/infoAfastamento/iniAfastamento/dtIniAfast', required: true, type: 'date' },
  ...
  'S-2299': [
    ...
    { path: 'eSocial/evtDeslig/ideTrabalhador/cpfTrab', required: true, minLength: 11, maxLength: 11, pattern: '^\\d{11}$' },
  ...
  'S-1200': [
    ...
    { path: 'eSocial/evtRemun/ideEvento/perApur', required: true, minLength: 7, maxLength: 7, pattern: '^\\d{4}-\\d{2}$' },
    ...
    { path: 'eSocial/evtRemun/ideTrabalhador/cpfTrab', required: true, minLength: 11, maxLength: 11, pattern: '^\\d{11}$' },
  ...
  'S-1210': [
    ...
    { path: 'eSocial/evtPgtos/ideEvento/perApur', required: true, minLength: 7, maxLength: 7, pattern: '^\\d{4}-\\d{2}$' },
    ...
    { path: 'eSocial/evtPgtos/ideTrabalhador/cpfTrab', required: true, minLength: 11, maxLength: 11, pattern: '^\\d{11}$' },
  ...
  'S-1299': [
    ...
    { path: 'eSocial/evtFechaEvPer/ideEvento/perApur', required: true, minLength: 7, maxLength: 7, pattern: '^\\d{4}-\\d{2}$' },
    ...
    { path: 'eSocial/evtFechaEvPer/ideEmpregador/nrInsc', required: true, minLength: 8, maxLength: 14 },
    { path: 'eSocial/evtFechaEvPer/ideRespInf/nmResp', required: true, minLength: 2, maxLength: 70 },
  ...
  'S-2210': [
    ...
    { path: 'eSocial/evtCAT/ideTrabalhador/cpfTrab', required: true, minLength: 11, maxLength: 11, pattern: '^\\d{11}$' },
  ...
  'S-2220': [
    ...
    { path: 'eSocial/evtMonit/ideTrabalhador/cpfTrab', required: true, minLength: 11, maxLength: 11, pattern: '^\\d{11}$' },
  ...
  'S-2240': [
    ...
    { path: 'eSocial/evtExpRisco/ideEmpregador/nrInsc', required: true, minLength: 8, maxLength: 14 },
    { path: 'eSocial/evtExpRisco/ideTrabalhador/cpfTrab', required: true, minLength: 11, maxLength: 11, pattern: '^\\d{11}$' },
