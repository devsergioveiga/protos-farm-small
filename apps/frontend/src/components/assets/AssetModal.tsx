    ...
    try {
      if (hasFinancialData && !isEdit) {
        ...
        const result = await createAcquisition({
          ...
          installmentCount:
            paymentType === 'FINANCIADO' && typeof installmentCount === 'number'
              ? installmentCount
              : undefined,
          firstDueDate: paymentType === 'FINANCIADO' ? firstDueDate || undefined : undefined,
          interestRate:
            paymentType === 'FINANCIADO' && interestRate
              ? parseFloat(interestRate.replace(',', '.')) || undefined
              : undefined,
        });
            ...
            <section className="asset-modal__section">
              ...
              <div className="asset-modal__field">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setField('classification', e.target.value as AssetClassification)
                  }
            ...
            {acquisitionValue > 0 && !isEdit && (
              <section className="asset-modal__section asset-modal__financial-section">
                <button
                  ...
                  aria-label={
                    financialExpanded ? 'Recolher Dados Financeiros' : 'Expandir Dados Financeiros'
                  }
                >
                ...
                <div
                  className="asset-modal__financial-body"
                  style={{ display: financialExpanded ? 'block' : 'none' }}
                >
                  ...
                  <fieldset className="asset-modal__fieldset">
                    ...
                    <div className="asset-modal__payment-cards">
                      ...
                      >
                        ...
                        <span className="asset-modal__payment-card-desc">
                      ...
                      <span className="asset-modal__classification-chip">
                        {
                          ASSET_CLASSIFICATION_LABELS[
                            formData.classification as AssetClassification
                          ]
                        }
                      </span>
                    </div>
