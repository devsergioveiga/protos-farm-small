...
// ─── Known labels in the IE document ───────────────────────────────

const KNOWN_LABELS = new Set([
  'INSCRIÇÃO ESTADUAL',
  'CPF',
  'NOME DO RESPONSÁVEL',
  'NOME DO ESTABELECIMENTO / PROPRIEDADE RURAL',
  'NOME DO ESTABELECIMENTO',
  'CNAE/DESCRIÇÃO',
  'CNAE/DESCRICAO',
  'REGIME DE APURAÇÃO / ENQUADRAMENTO',
  'REGIME DE APURACAO / ENQUADRAMENTO',
  'CATEGORIA',
  'DATA DA INSCRIÇÃO',
  'DATA DA INSCRICAO',
  ...
  'DADOS CADASTRAIS',
  'PARTICIPANTES DA SOCIEDADE EM COMUM DE PRODUTOR RURAL',
